...
[![My Skills](https://skillicons.dev/icons?i=html,css,scss,tailwindcss,js,ts,python,jquery,lit,vue,react,redux,vite,vitest,webpack,postman,git,npm,sublime,vscode,visualstudio)](https://github.com/ghost160111)
...
- Web app optimization techniques, lazy loading, image optimizations, css styles splitting
- Vite, Vitest, Npm, Git
